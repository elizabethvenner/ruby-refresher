...
def remove_nils_and_false_from_array(array)
  array.select {|element| element if element}
...
def separate_array_into_even_and_odd_numbers(array)
  even = array.select{|element| element.even?}
  odd = array.select{|element| element.odd?}
  array = [even, odd]
end
...
def number_of_elements_that_are_palindromes(array)
  array.select!{|element| element == element.reverse}
  array.count
end
...
def get_elements_until_greater_than_five(array)
  array[0..((array.index{|element| element > 5})-1)]
end
...
def get_all_letters_in_array_of_words(array)
  array.map{|x| x.split(//)}.flatten.sort
end
...
def titleize_a_string(string)
  array = string.split(' ')
  non_caps = ['a', 'and', 'the']
  array.map{|word| word.capitalize! unless (word != array.first) && (non_caps.include? word)}
  array.join(' ')
end
